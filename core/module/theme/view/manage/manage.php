...
<div class="row">
	<div class="col12">
		<div class="block">
			<h4>
				<?php echo helper::translate('Installer un thème archivé (site ou administration)'); ?>
			</h4>
			<div class="row">
...
<div class="row">
	<div class="col6">
		<div class="block">
			<h4>
				<?php echo helper::translate('Sauvegarde du thème dans le'); ?>
	...
	<div class="col6">
		<div class="block">
			<h4>
				<?php echo helper::translate('Télécharger le thème'); ?>
			</h4>
			<div class="row">
				<div class="col6">
