...
class download extends common
{
	...
	public function config()
	{
		...
		for ($i = $pagination['first']; $i < $pagination['last']; $i++) {
			...
			// Met en forme le tableau
			$date = mb_detect_encoding(\PHP81_BC\strftime('%d %B %Y', $this->getData(['module', $this->getUrl(0), 'posts', $itemIds[$i], 'versionDate'])), 'UTF-8', true)
				? \PHP81_BC\strftime('%d %B %Y', $this->getData(['module', $this->getUrl(0), 'posts', $itemIds[$i], 'versionDate']))
				: utf8_encode(\PHP81_BC\strftime('%d %B %Y', $this->getData(['module', $this->getUrl(0), 'posts', $itemIds[$i], 'versionDate'])));
			//$heure = mb_detect_encoding(\PHP81_BC\strftime('%H:%M', $this->getData(['module', $this->getUrl(0), 'posts', $itemIds[$i], 'versionDate'])), 'UTF-8', true)
			//	? \PHP81_BC\strftime('%H:%M', $this->getData(['module', $this->getUrl(0), 'posts', $itemIds[$i], 'versionDate']))
			//	: utf8_encode(\PHP81_BC\strftime('%H:%M', $this->getData(['module', $this->getUrl(0), 'posts', $itemIds[$i], 'versionDate'])));
	...
	public function setup()
	{
		...
		if ($this->isPost()) {
			...
			// Valeurs en sortie
			$this->addOutput([
				'redirect' => helper::baseUrl() . $this->getUrl(0) . '/setup',
	...
	public function stats()
	{
		...
		for ($i = $pagination['first']; $i < $pagination['last']; $i++) {
			...
			$date = mb_detect_encoding(\PHP81_BC\strftime('%d %B %Y - %H:%M', $this->getData(['module', $this->getUrl(0), 'posts', $this->getUrl(2), 'stats', $itemIds[$i], 'time'])), 'UTF-8', true)
				? \PHP81_BC\strftime('%d %B %Y - %H:%M', $this->getData(['module', $this->getUrl(0), 'posts', $this->getUrl(2), 'stats', $itemIds[$i], 'time']))
				: utf8_encode(\PHP81_BC\strftime('%d %B %Y - %H:%M', $this->getData(['module', $this->getUrl(0), 'posts', $this->getUrl(2), 'stats', $itemIds[$i], 'time'])));
