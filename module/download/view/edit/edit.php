				...
				<div class="row">
					...
					<div class="col3">
						<?php echo template::text('downloadEditVersion', [
							'label' => 'Version',
							'value' => $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(2), 'version'])
						]); ?>
					</div>
					<div class="col3">
						<?php echo template::date('downloadEditversionDate', [
							'label' => 'Publiée le',
							'value' => $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(2), 'versionDate'])
						]); ?>
					</div>
				</div>
				<div class="row">
					<div class="col3">
						<?php echo template::text('downloadEditAuthor', [
							'label' => 'Auteur',
							'value' => $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(2), 'author'])
						]); ?>
					</div>
					<div class="col3">
						<?php echo template::select('downloadEditLicense', $module::$licenses, [
							'label' => 'Licence',
							'selected' => $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(2), 'license'])
						]); ?>
					</div>
					<div class="col3">
					...
					<div class="col3">
						<?php echo template::file('downloadEditThumb', [
							...
							'type' => 1,
							'value' => $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(2), 'thumb'])
						]); ?>
					</div>
				</div>
				<div class="row">
					<div class="col3">
						<?php echo template::select('downloadEditRessourceType', $module::$ressourceType, [
							...
							'selected' => $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(2), 'ressourceType'])
						]); ?>
					</div>
					<div class="col9">
						<div class="row">
							...
							<div class="col12">
								<?php echo template::text('downloadEditUrl', [
									'label' => 'URL',
									'value' => $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(2), 'url']),
									'placeholder' => 'https://'
								]); ?>
							</div>
						</div>
