<div class="row">
	<div class="col3 itemInfo">
		<?php if ($this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'thumb'])): ?>
			<div class="row">
				<div class="col12">
					<?php
						$pictureSize =  $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'pictureSize']) === null ? '100' : $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'pictureSize']);
						$parts = explode('/',$this->getData(['module', $this->getUrl(0), 'items',$this->getUrl(1), 'thumb']));
						$thumb = str_replace ($parts[(count($parts)-1)],'mini_' . $parts[(count($parts)-1)], $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'thumb']));
						echo '<img class="downloadItemPicture" src="' . helper::baseUrl(false) . self::FILE_DIR . 'thumb/' . $thumb .
							'" alt="' . $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'thumb']) . '">';
					?>
				</div>
			</div>
		<?php endif; ?>
		<?php if ($this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'ressourceType']) !== 'content'): ?>
			<div class="row">
				<div class="col12">
					<?php
		...
		<?php endif; ?>
		<?php if ($this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'version']) ): ?>
			<div class="row">
				<div class="col12 textAlignCenter">
					<?php echo 'Version n°' .  $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'version']); ?>
				</div>
			</div>
		<?php endif; ?>
		<?php if ($this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'date']) ): ?>
			<div class="row">
				<div class="col12 textAlignCenter">
					<?php	$date = mb_detect_encoding(strftime('%d %B %Y', $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'date'])), 'UTF-8', true)
							? strftime('%d %B %Y', $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'date']))
							: utf8_encode(strftime('%d %B %Y', $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'date'])));
							echo ' du ' .  $date;
					?>
				</div>
			</div>
		...
		<div class="row">
			<div class="col12 textAlignCenter">
				<span>Auteur :
				<?php echo $this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'author']); ?>
				</span>
			</div>
		</div>
		<div class="row">
			<div class="col12 textAlignCenter">
				<span>Licence :
				<?php echo $module::$licenses[$this->getData(['module', $this->getUrl(0), 'items', $this->getUrl(1), 'license'])]; ?>
				</span>
			</div>
		</div>
