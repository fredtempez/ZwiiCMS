...
var snipcart = (function () {
	...
	tinymce.PluginManager.add('snipcart', function (editor, url) {
		...
		function _onAction(){
			...
			$.get('./site/data/snipcart/default.dat', function(datajson) {
				...
				var body = [
					...
					{	//Onglet Options
						...
						[	// Container html
							...
							name   : 'container',
							label  : '',
							html   : '<p><a href="https://docs.snipcart.com/v3/setup/products" target="_blank">Documentation Snipcart</a></p><p>&nbsp;</p><p>Pour permettre au client de choisir une option avec une liste déroulante</p><p>Voir "Custom Fields"  et "1.Droptown", ne pas saisir les guillemets double (")</p>'
							},
					...
					{	//Onglet Textes
						...
						[	
							...
							name   : 'container',
							label  : '',
							html   : '<p><a href="https://docs.snipcart.com/v3/setup/products" target="_blank">Documentation Snipcart</a></p><p>&nbsp;</p><p>Pour permettre au client d\'insérer un texte</p><p>Voir "Custom Fields"  et "4.Texarea", ne pas saisir les guillemets double (")</p>'
							},
							...
							name   : 'container',
							label  : '',
							html   : '<p>&nbsp;</p><p>Pour vous permettre d\'afficher un texte</p><p>Voir "Custom Fields"  et "5.Readonly", ne pas saisir les guillemets double (")</p>'
							},
					...
					{	//Onglet Avancé
						...
						[	// Container html
							...
							name   : 'container',
							label  : '',
							html   : '<p><a href="https://docs.snipcart.com/v3/setup/products" target="_blank">Documentation Snipcart</a></p><p>&nbsp;</p><p>Vous pouvez saisir des attributs "data-..." et leur valeur, exemple :</p><p><font face="Arial"><em> data-item-custom5-name="Cadeau" data-item-custom5-type="checkbox" </em></font></p><p><a href="module/snipcart/ressource/interdits.html" target="_blank">ATTENTION Consultez la liste des attributs interdits !</a></p>'
							},
							// Champ libre
							{type: 'textbox',
							name: 'textCustomFree',
