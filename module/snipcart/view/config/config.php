...
<?php echo template::textarea('snipcartContent', [
	'class' => 'editorWysiwygSnipcart',
	'value' => $this->getData(['module', $this->getUrl(0), 'content']),
]); ?>
<div class="block">
...
<div class="block">
	<h4>Documentation</h4>
	<p style="text-align: left;"><a href="https://app.snipcart.com/" target="_blank" rel="noopener"
			title="Page de connexion du site Snipcart">Page de connexion du site Snipcart</a></p>
	<p style="text-align: left;"><a href="./module/snipcart/ressource/snipcart_mode_emploi.pdf" target="_blank"
			title="Documentation Snipcart avec Zwii" rel="noopener">Documentation Snipcart avec Zwii</a></p>
</div>
